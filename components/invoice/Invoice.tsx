      ...
      <div className="order-invoice my-5">
        <div className="row d-flex justify-content-center mb-5">
          <button className="btn btn-success col-md-5" onClick={handleDownload}>
            <i aria-hidden className="fa fa-print"></i> Download Invoice
          </button>
        </div>
        <div className="px-5">
          <div id="booking_invoice" className="px-4 border border-secondary">
            <header className="clearfix">
              ...
              <div id="company" className="clearfix">
                ...
                <div>
                  <a href="mailto:info@bookit.com">info@Lawconnect.com</a>
                </div>
              </div>
              <div id="project">
                <div>
            ...
            <main>
              <table className="mt-5">
                ...
                <tbody>
                  <tr>
                    <td className="service">{booking?.product?.name}</td>
                    <td className="desc">${booking?.product?.price}</td>
                  </tr>
